...
interface WithTeams
{
     ...
     * @param TeamFilter[] $filters  Filters to filter the returned teams (ex. if you only want to get the first 3
     *                               teams)
     *
     * @return Team[]
     */
     ...
     */
    public function addTeamContainer(TeamContainer $teamContainer) : WithTeams;
}
