...
class ImportValidatorTest extends TestCase
{
    ...
    public function testTypeValidation(array|bool|int|stdClass|string $data, array $types, bool $valid) : void {
        if (!$valid) {
            $this->expectException(InvalidImportDataException::class);
        }
    ...
    public static function getTestedTypes() : array {
        return [
            ['aaa', ['string'], true],
            [['aaa'], ['string'], false],
            [1, ['int'], true],
    ...
    public static function groupParents() : array {
        return [
            [
                [
                    'groups' => [
