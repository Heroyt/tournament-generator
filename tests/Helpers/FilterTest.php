...
class FilterTest extends TestCase
{
     ...
     */
    #[Test]
    public function checkFilterCreation() : void {
    ...
    #[Test]
    public function checkFilterCreationMulti() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiRound() : void {
    ...
    #[Test]
    public function checkFilterCreationMultiTournament() : void {
    ...
    #[Test]
    public function checkFilterCreationMultiFalseFilterMulti() : void {
        $group = new Group('Group', 'g1');
        ...
        new TeamFilter('points', '>', 3, [$group]);    // Team 2, Team 3, Team 4
        new TeamFilter('score', '>', 400, [$group]);   // Team 2, Team 3
        new TeamFilter('score', '=', 200, [$group]);   // Team 1
        new TeamFilter('draws', '>=', 1, [$group]);    // Team 2, Team 3
        new TeamFilter('score', '<', 450, [$group]);   // Team 1, Team 3, Team 4
        new TeamFilter('team', '=', $team2, [$group]); // Team 2
    ...
    #[Test]
    public function checkFilterCreationMultiFalseOperandMulti() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiFalseFilterAnd() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiFalseOperrandAnd() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiFalseFilterOr() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiFalseOperandOr() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkFilterCreationMultiWithDoubleComp() : void {
        $group = new Group('Group', 'g1');
