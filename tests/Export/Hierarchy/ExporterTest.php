...
class ExporterTest extends TestCase
{
    ...
    public function testBasicExport(Tournament $tournament, array $expectedTeams, array $expectedGames, array $expectedSetup) : void {
    ...
    public function testModifiedExport(Tournament $tournament, array $expectedTeams, array $expectedGames, array $expectedSetup) : void {
    ...
    public static function getModifiedTournamentData() : array {
        return [
            self::tournamentSetup(false, true),
            self::tournamentSetup(true, true),
        ];
    }
    ...
    public function testCategoryRoundsGroupsExport() : void {
        ...
        $games1 = array_map(static fn (Game $game) => (object) [
            'id'     => $game->getId(),
            'teams'  => $game->getTeamsIds(),
            'scores' => [],
        ], $group1->genGames());
        $games2 = array_map(static fn (Game $game) => (object) [
            'id'     => $game->getId(),
            'teams'  => $game->getTeamsIds(),
            'scores' => [],
        ], $group2->genGames());
