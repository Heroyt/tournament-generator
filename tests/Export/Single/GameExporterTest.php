...
class GameExporterTest extends TestCase
{
    ...
    public static function getGames() : array {
        ...
        $withGames = new Group('Group', 1)->setInGame(3)->setGameAutoincrementId(5);
