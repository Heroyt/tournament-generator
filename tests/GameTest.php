...
class GameTest extends TestCase
{
    ...
    #[Test]
    public function checkCreationGame() : void {
    ...
    #[Test]
    public function checkCreationFalseTeamsGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkGetGroupGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkAddingTeamsGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkAddingTeamsFalseGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkGetTeamByIdGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkGetTeamByIdUnexistingTeamGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkGetTeamsIdsGame() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkSettingResults2Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkSettingResults2DrawGame() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkSettingResultsFalseGame() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkSettingResultsFalseTeamGame() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkSettingResults3Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(3);
    ...
    #[Test]
    public function checkSettingResults4Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(4);
    ...
    #[Test]
    public function checkGettingLossAndWinTeams2Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkGettingDrawTeams2Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(2);
    ...
    #[Test]
    public function checkGettingWinSecondThirdAndLossTeams4Game() : void {
        $group = new Group('Group', 'g1');
        $group->setInGame(4);
