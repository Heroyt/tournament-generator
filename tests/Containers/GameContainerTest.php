...
class GameContainerTest extends TestCase
{
    ...
    public function testAutoIncrementFromHierarchy() : void {
        ...
        $gameContainer = $round->getGameContainer();
        ...
        $containers = [$gameContainer, $group1Container, $group2Container];
        foreach ($containers as $container) {
            self::assertEquals(1, $container->getAutoIncrement());
        }
    ...
    public function testAutoIncrementFromHierarchy2() : void {
        ...
        $gameContainer = $category->getGameContainer();
        ...
        $containers = [$gameContainer, $round1Container, $round2Container, $group1Container, $group2Container, $group3Container, $group4Container];
        foreach ($containers as $container) {
            self::assertEquals(1, $container->getAutoIncrement());
        }
    ...
    public function testAutoIncrementFromHierarchy3() : void {
        ...
        $gameContainer = $tournament->getGameContainer();
