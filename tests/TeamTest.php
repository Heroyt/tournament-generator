...
class TeamTest extends TestCase
{
    ...
    #[Test]
    public function checkNameSetupTeam() : void {
    ...
    #[Test]
    public function checkIdSetupTeam() : void {
    ...
    #[Test]
    public function checkGettingGamesWithTeam() : void {
    ...
    #[Test]
    public function checkAddingGroupTeam() : void {
        $group = new Group('Group', 'g1');
    ...
    #[Test]
    public function checkAddingAndRemovingScoresTeam() : void {
    ...
    #[Test]
    public function checkAddingAndRemovingPointsTeam() : void {
