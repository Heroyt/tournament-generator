...
{
    #[Test]
    public function checkNameSetupCategory() : void {
    ...
    #[Test]
    public function checkIdCategoryRound() : void {
    ...
    #[Test]
    public function checkRoundAddCategory() : void {
    ...
    #[Test]
    public function checkRoundCreationCategory() : void {
    ...
    #[Test]
    public function checkSkipCategory() : void {
    ...
    #[Test]
    public function checkRoundInheritsSkipCategory() : void {
    ...
    #[Test]
    public function checkTeamAddCategory() : void {
    ...
    #[Test]
    public function checkTeamCreationCategory() : void {
    ...
    #[Test]
    public function checkTeamsFromRoundsCategory() : void {
    ...
    #[Test]
    public function checkSplitTeamsCategory() : void {
    ...
    #[Test]
    public function checkSplitTeamsWithDefinedRoundsCategory() : void {
    ...
    #[Test]
    public function checkGenGamesSimulateCategory() : void {
    ...
    #[Test]
    public function checkGenGamesSimulateRealCategory() : void {
    ...
    #[Test]
    public function checkSortingTeamsCategory() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $category->sortTeams());
    ...
    #[Test]
    public function checkSortingTeamsFromGetTeamsCategory() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $category->getTeams(true));
    ...
    #[Test]
    public function checkSortingTeamsByScoreCategory() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $category->sortTeams(Constants::SCORE));
