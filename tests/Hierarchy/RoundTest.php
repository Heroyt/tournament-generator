...
{
    #[Test]
    public function checkNameSetupRound() : void {
    ...
    #[Test]
    public function checkIdSetupRound() : void {
    ...
    #[Test]
    public function checkGroupAddRound() : void {
    ...
    #[Test]
    public function checkGroupCreationRound() : void {
    ...
    #[Test]
    public function checkGettingGroupIdsRound() : void {
    ...
    #[Test]
    public function checkOrderingGroupsRound() : void {
        ...
        // Test if the group was added
        $groups = array_map(static fn ($a) : int|string => $a->getId(), $round->orderGroups());
        self::assertSame([3, 1, 2], $groups);

    }

    #[Test]
    public function checkSkipRound() : void {
    ...
    #[Test]
    public function checkGroupInheritsSkipRound() : void {
    ...
    #[Test]
    public function checkTeamAddRound() : void {
        ...
        $withTeams = $round->addTeam($team);
        self::assertCount(1, $round->getTeams());

        // Test if the output is $this
        self::assertInstanceOf(Round::class, $withTeams);
    ...
    #[Test]
    public function checkTeamCreationRound() : void {
    ...
    #[Test]
    public function checkSplitTeamsRound() : void {
    ...
    #[Test]
    public function checkSplitTeamsWithDefinedGroupsRound() : void {
    ...
    #[Test]
    public function checkSortingTeamsRound() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $round->sortTeams());
    ...
    #[Test]
    public function checkSortingTeamsFromGetTeamsRound() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $round->getTeams(true));
    ...
    #[Test]
    public function checkSortingTeamsByScoreRound() : void {
        ...
        $teamsSorted = array_map(static fn ($team) : string => $team->getName(), $round->sortTeams(Constants::SCORE));
    ...
    #[Test]
    public function checkGamesGenerationRound() : void {
    ...
    #[Test]
    public function checkPlayedRound() : void {
    ...
    #[Test]
    public function checkProgressRound() : void {
    ...
    #[Test]
    public function checkProgressBlankRound() : void {
    ...
    #[Test]
    public function checkAddingTeams() : void {
