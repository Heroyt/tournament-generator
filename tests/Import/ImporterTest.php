...
class ImporterTest extends TestCase
{
    ...
    public static function tournamentExports() : array {
        return [
            [
                [
                    'tournament' => (object) [
    ...
    public static function categoryExports() : array {
        return [
            [
                [
                    'categories' => [
    ...
    public static function roundExports() : array {
        return [
            [
                [
                    'rounds' => [
    ...
    public static function groupExports() : array {
        return [
            [
                [
                    'groups' => [
    ...
    public static function teamExports() : array {
        return [
            [
                [
                    'teams' => [
    ...
    public function testComplexImport(array $data) : void {
        ...
        foreach ($data['games'] ?? [] as $setting) {
            ...
            if (isset($setting->scores)) {
                $expected = array_map(static fn ($object) : array => (array) $object, $setting->scores);
            ...
            foreach ([[$progressions1, $to1], [$progressions2, $to2]] as [$progressions, $to]) {
                ...
                foreach ($progressions as $progression) {
                    if ($progression->getTo() === $to) {
                        if (
                            isset($setting->offset, $setting->length, $setting->filters)
                        ...
                        if (
                            isset($setting->offset, $setting->length)
                            && $progression->getStart() === $setting->offset
                            && $progression->getLen() === $setting->length
                            && 0 === count($progression->getFilters())
                        ) {
                            $found = true;
                            if (isset($setting->progressed)) {
                                self::assertSame($setting->progressed, $progression->isProgressed());
                        ...
                        if (
                            isset($setting->offset, $setting->filters)
                            && $progression->getStart() === $setting->offset
                            && null === $progression->getLen()
                            && count($progression->getFilters()) === count($setting->filters)
                        ) {
                            $found = true;
                            $this->checkFilters($setting->filters, $progression->getFilters());
                        ...
                        if (
                            isset($setting->length, $setting->filters)
                            && 0 === $progression->getStart()
                            && $progression->getLen() === $setting->length
                            && count($progression->getFilters()) === count($setting->filters)
                        ) {
                            $found = true;
    ...
    public static function complexExports() : array {
        return [
            [
                [
                    'tournament' => (object) [
    ...
    private function checkFilters(array $setting, array $filters) : void {
        foreach ($setting as $key => $filterSetting) {
            ...
            foreach ($filters as $filter) {
                ...
                if (
                    isset($filterSetting->what, $filterSetting->how, $filterSetting->val, $filterSetting->groups)
                ...
                if (
                    isset($filterSetting->how, $filterSetting->val, $filterSetting->groups)
                ...
                if (
                    isset($filterSetting->what, $filterSetting->val, $filterSetting->groups)
                    && $filterSetting->what === $filter->getWhat()
                    && '>' === $filter->getHow()
                    && $filterSetting->val === $filter->getVal()
                    && $filterSetting->groups === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->what, $filterSetting->how, $filterSetting->groups)
                    && $filterSetting->what === $filter->getWhat()
                    && $filterSetting->how === $filter->getHow()
                    && 0 === $filter->getVal()
                    && $filterSetting->groups === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->what, $filterSetting->how)
                    && $filterSetting->what === $filter->getWhat()
                    && $filterSetting->how === $filter->getHow()
                    && 0 === $filter->getVal()
                    && [] === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->what, $filterSetting->groups)
                    && $filterSetting->what === $filter->getWhat()
                    && '>' === $filter->getHow()
                    && 0 === $filter->getVal()
                    && $filterSetting->groups === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->val, $filterSetting->groups)
                    && 'points' === $filter->getWhat()
                    && '>' === $filter->getHow()
                    && $filterSetting->val === $filter->getVal()
                    && $filterSetting->groups === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->what, $filterSetting->val)
                    && $filterSetting->what === $filter->getWhat()
                    && '>' === $filter->getHow()
                    && $filterSetting->val === $filter->getVal()
                    && [] === $filter->getGroups()
                ...
                if (
                    isset($filterSetting->how, $filterSetting->groups)
                    && 'points' === $filter->getWhat()
                    && $filterSetting->how === $filter->getHow()
                    && 0 === $filter->getVal()
                    && $filterSetting->groups === $filter->getGroups()
