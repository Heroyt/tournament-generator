...
class TeamExporterTest extends TestCase
{
    ...
    public function testBasicExport(Team $team, array $expectedOutput, array $scores) : void {
    ...
    public static function getTeams() : array {
        ...
        return [
            ...
            [
                ...
                [
                    1 => [
                        'points' => ($group1->getWinPoints() * 5) + ($group1->getDrawPoints() * 5) + $group1->getLostPoints(),
                        'score'  => 1234,
                        'wins'   => 5,
                        'draws'  => 5,
                        'losses' => 1,
