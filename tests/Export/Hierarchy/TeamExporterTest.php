...
class TeamExporterTest extends TestCase
{
    ...
    public function testSingleTeamExport(Team $team, array $expected, array $scores) : void {
    ...
    #[DataProvider('getSingleTeam')]
    public function testSingleTeamExportWithScores(Team $team, array $expected, array $scores) : void {
    ...
    public static function getSingleTeam() : array {
        ...
        return [
            ...
            [
                ...
                [
                    0 => [
                        'points' => $group->getLostPoints() * 2 + $group->getWinPoints(),
                        'score' => 600,
                        'wins' => 1,
                        'losses' => 2,
                        'draws' => 0,
            ...
            [
                ...
                [
                    0 => [
                        'points' => $group->getLostPoints() + $group->getWinPoints() * 2,
                        'score' => 900,
                        'wins' => 2,
                        'losses' => 1,
                        'draws' => 0,
